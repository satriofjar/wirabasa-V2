...
* @see app/Http/Controllers/OrderController.php:45
* @route '/order-product'
*/
...
* @see app/Http/Controllers/OrderController.php:113
* @route '/order-product/{order_product}'
*/
...
const OrderController = { create, index, store, show, edit, update, destroy }
